...
<html class="no-js">
  <head>
    ...
    <!-- CSS -->
<?php 
  include("modules/external_css.php");
?>
    <!-- Js -->
<?php 
  include("modules/external_scripts.php");
?>
              ...
              <div class="col-md-6 col-sm-12">
                <div class="block">
                  ...
                  <ul class="address-block">
                    <li>
                      <i class="fa fa-map-marker"></i>12250 ATLANTIC BLVD APT 607 JACKSONVILLE, FL 32225
                    </li>
                    <li>
                      <i class="fa fa-envelope-o"></i>Email: a1acleaners@gmail.com
                    </li>
                    <li>
                      <i class="fa fa-phone"></i>Phone: Aurelina R. Salcedo: +904 576 46 90 </br>
                      Pedro M. Acosta: +904 888 96 03
                    </li>
                  </ul>
